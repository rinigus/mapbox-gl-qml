...
QSGMapboxGLAbstractNode::QSGMapboxGLAbstractNode(const QMapLibreSettings &settings, const QSize &size,
...
{
  m_map.reset(new QMapLibreGL(nullptr, settings, size.expandedTo(minTextureSize), pixelRatio));

  QObject::connect(m_map.data(), &QMapLibreGL::needsRendering, item, &QQuickItem::update);
  QObject::connect(m_map.data(), &QMapLibreGL::copyrightsChanged, item, &QQuickItem::update);
}
...
QSGMapboxGLTextureNode::QSGMapboxGLTextureNode(const QMapLibreSettings &settings, const QSize &size,
...
QSGMapboxGLRenderNode::QSGMapboxGLRenderNode(const QMapLibreSettings &settings, const QSize &size,
                                             qreal devicePixelRatio, qreal pixelRatio, QQuickItem *item)
  : QSGMapboxGLAbstractNode(settings, size, devicePixelRatio, pixelRatio, item)
{
