...
void SourceList::remove(const QString &id) { add_to_stack(Action::Remove, id, QVariantMap()); }
...
LayerList::LayerAction::LayerAction(Type t, const QString id, const QVariantMap params,
    ...
    : Action(t), m_asset(id, params, before) {
